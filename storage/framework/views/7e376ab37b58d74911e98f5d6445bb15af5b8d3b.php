		...
		<div class="row">
			<nav class="footer-nav">
				<ul>
					...
					<li><a href="<?php echo e(route('user.events.index')); ?>">Event List</a></li>
...
<?php /**PATH C:\xampp\htdocs\campus-event\resources\views/layouts/user/footer.blade.php ENDPATH**/ ?>