        ...
        <div class="main">
            <div class="section">
                <div class="container">
                    ...
                    <?php endif; ?>
                    <form method="post" action="<?php echo e(route('admin.events.create.process')); ?>"
                            ...
                            <div class="col-md-5 col-sm-5">
                                ...
                                <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail img-no-padding" style="
                                            ...
                                            max-height: 250px;
                                        ">
                                        <img src="<?php echo e(asset('assets')); ?>/img/image_placeholder.jpg" alt="Event Image" />
                                    </div>
                                ...
                                <h6>Famous Person</h6>
                                <input type="text" name="famous_person" value="<?php echo e(old('famous_person')); ?>"
                                    data-role="tagsinput" placeholder="Idol Name" />
                                <h6>Free Food</h6>
                                <input type="text" name="free_food" value="<?php echo e(old('free_food')); ?>" data-role="tagsinput"
                            ...
                            <div class="col-md-7 col-sm-7">
                                ...
                                <div class="row price-row" style="margin-top: -15px">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="start_date" value="<?php echo e(old('start_date')); ?>"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" name="end_date" value="<?php echo e(old('end_date')); ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control textarea-limited" name="description"
                                        ...
                                        maxlength="255"><?php echo e(old('description')); ?></textarea>
                                    <h5>
...
<?php echo $__env->make('layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\campus-event\resources\views/admin/events/create.blade.php ENDPATH**/ ?>